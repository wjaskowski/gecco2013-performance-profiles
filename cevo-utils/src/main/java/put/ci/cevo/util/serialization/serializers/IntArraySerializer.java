...
public class IntArraySerializer implements ObjectSerializer<int[]> {
	@Override
	public void save(int[] arr, SerializationOutput output) throws IOException {
	...
	@Override
	public int[] load(SerializationInput input) throws IOException, SerializationException {
